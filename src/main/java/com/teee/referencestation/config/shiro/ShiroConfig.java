...
import com.teee.referencestation.config.shiro.cache.CustomCacheManager;
import com.teee.referencestation.config.shiro.jwt.JwtFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager) {
        ...
        // 不验证升级请求
        filterRuleMap.put("/upgrade", "anon");
        filterRuleMap.put("/test/api", "anon");
        filterRuleMap.put("/prometheus", "anon");
        filterRuleMap.put("/actuator", "anon");
        filterRuleMap.put("/metrics", "anon");
