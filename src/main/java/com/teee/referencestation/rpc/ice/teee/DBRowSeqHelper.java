...
public final class DBRowSeqHelper
{
    ...
    {
        final java.util.Map<String, String>[] v;
        final int len0 = istr.readAndCheckSeqSize(1);
        v = (java.util.Map<String, String>[])new java.util.Map[len0];
        for(int i0 = 0; i0 < len0; i0++)
        {
            v[i0] = DBRowHelper.read(istr);
        }
        return v;
    }
