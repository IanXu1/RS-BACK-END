...
public class WarningDevInfo implements Cloneable,
                                       java.io.Serializable
{
    ...
    public WarningDevInfo(long dev_id, long dev_sno, long bd_sno, long bd_type, long bd_slot_id, long locomotive_id, long locomotive_sno)
    {
        this.dev_id = dev_id;
        this.dev_sno = dev_sno;
        this.bd_sno = bd_sno;
    ...
    public boolean equals(Object rhs)
    {
        ...
        WarningDevInfo r = null;
        if(rhs instanceof WarningDevInfo)
        {
            r = (WarningDevInfo)rhs;
        }
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::teee::WarningDevInfo");
    ...
    public WarningDevInfo clone()
    {
        WarningDevInfo c = null;
        try
        {
            c = (WarningDevInfo)super.clone();
        }
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, WarningDevInfo v)
    {
        if(v == null)
        {
    ...
    static public WarningDevInfo ice_read(com.zeroc.Ice.InputStream istr)
    {
        WarningDevInfo v = new WarningDevInfo();
        v.ice_readMembers(istr);
        return v;
    }

    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, java.util.Optional<WarningDevInfo> v)
    {
    ...
    static public void ice_write(com.zeroc.Ice.OutputStream ostr, int tag, WarningDevInfo v)
    {
    ...
    static public java.util.Optional<WarningDevInfo> ice_read(com.zeroc.Ice.InputStream istr, int tag)
    {
        if(istr.readOptional(tag, com.zeroc.Ice.OptionalFormat.VSize))
        {
            istr.skipSize();
            return java.util.Optional.of(WarningDevInfo.ice_read(istr));
        }
        else
        {
    ...
    private static final WarningDevInfo _nullMarshalValue = new WarningDevInfo();

    public static final long serialVersionUID = 1518008907L;
}
